/*
    ...
    better stay to the same place! So the task is to give to the man a simplified version of the plan. A better
...
public class DirectionReduction {
    ...
    public static String[] dirReduc(String[] arr) {
        ...
        while (it.hasNext()) {
            String temp = it.next();
            if (it.hasNext()) {
                String tempNext = it.next();
                if (temp.equals("WEST") && tempNext.equals("EAST") || temp.equals("EAST") && tempNext.equals("WEST") ||
                        temp.equals("NORTH") && tempNext.equals("SOUTH") || temp.equals("SOUTH") && tempNext.equals("NORTH")) {
                    it.previous();
                    it.remove();
                    it.previous();
                    it.remove();
